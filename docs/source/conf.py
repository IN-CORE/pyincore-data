...
latex_documents = [
    (master_doc, 'pyIncore-data.tex', 'pyIncore-data Documentation',
     'NCSA', 'manual'),
]
...
man_pages = [
    (master_doc, 'pyIncore-data', 'pyIncore-data Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pyIncore-data', 'pyIncore-data Documentation',
     author, 'pyIncore-data', 'One line description of project.',
     'Miscellaneous'),
]
