...
htmlhelp_basename = "pyincoredatadoc"
...
latex_documents = [
    (master_doc, "pyIncore-data.tex", "pyIncore-data Documentation", "NCSA", "manual"),
]
...
man_pages = [(master_doc, "pyIncore-data", "pyIncore-data Documentation", [author], 1)]
